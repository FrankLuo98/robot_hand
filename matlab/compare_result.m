clear;
rosshutdown;
setenv('ROS_MASTER_URI', 'http://10.108.82.31:11311') %use ifconfig to find your raspberrypi ip
setenv('ROS_IP', '10.108.32.166');%use ipconfig to find your laptop ip
setenv('ROS_HOSTNAME', '10.108.32.166');%use ipconfig to find your laptop ip
%setenv('ROS_MASTER_URI', 'http://10.108.82.31:11311')
%rosinit( '10.108.32.166', 'NodeHost','10.108.32.166');
rosinit();
%setenv('ROS_MASTER_URI', 'http://10.108.32.166:11311');
